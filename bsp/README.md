...
* LCD A `hwspi-rgb888`: uf2loader互換初期化、SPI1 25 MHz、`COLMOD 0x66`、RGB888、RAMWRウィンドウ中CS保持
* LCD B `pio-rgb565`: `general/lcd`互換PIO0 blocking送信、`COLMOD 0x65`、RGB565、PIO停止後SIOでRAMRD
