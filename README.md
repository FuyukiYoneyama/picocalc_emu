...
- NES-class preview fixture（synthetic NROM、3回local firmware evidence）: [`docs/validated-realtime-preview/VRP_NES0_NES_CLASS_FIXTURE_20260829.md`](docs/validated-realtime-preview/VRP_NES0_NES_CLASS_FIXTURE_20260829.md)。診断NESco source commitの公開ref待ちのためtargetは`pending-revalidation`であり、`realtime-1x-qualified`ではありません
