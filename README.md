...
- 1倍UX qualification workload: [`docs/validated-realtime-preview/VRP_LOAD0_SUSTAINED_LOAD_20260829.md`](docs/validated-realtime-preview/VRP_LOAD0_SUSTAINED_LOAD_20260829.md)。`VRP-LOAD-0`はrepository-ownedな320x320 RGB565全画面、48 kHz DMA音声、継続CPU負荷、clean clone再現性を固定する計画で、実装・測定は未着手です
