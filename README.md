...
- NES-class preview fixture（synthetic NROM、3回local firmware evidence）: [`docs/validated-realtime-preview/VRP_NES0_NES_CLASS_FIXTURE_20260829.md`](docs/validated-realtime-preview/VRP_NES0_NES_CLASS_FIXTURE_20260829.md)。NEScoは独立プロジェクトで診断sourceはローカルのみのためtargetは`pending-revalidation`です。`picocalc_emu`はNEScoを改造・公開・pushせず、`realtime-1x-qualified`へは昇格しません
