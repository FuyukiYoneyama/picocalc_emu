...
VRP-2-eの`c1c20d7d86a3006569375bc333cf72494e95eb46`は当時の不変evidenceとして保持しますが、現在のbackend branch／tagから到達できない歴史的pinです。VRP-5 reusable backend-pin preflightでは、到達可能なclean backend `65c795e87321e79b960ac8a7495a205de6a24ec0`で新しいversioned target／validation／receiptを作成し、admissionとheadless preview consumerまで確認済みです。ただし、これはqualification完了ではありません。`LOAD-0`の役割レビューと1倍速UXプロジェクトの中断判断は[`VRP_1X_PROJECT_SUSPENSION_DECISION_20260903.md`](docs/validated-realtime-preview/VRP_1X_PROJECT_SUSPENSION_DECISION_20260903.md)に固定しています。
