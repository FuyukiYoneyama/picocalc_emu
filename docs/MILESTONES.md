...
fixtureと証拠は完了済みです。詳細計画を[`SD_GEN1_IMPLEMENTATION_PLAN_20260823.md`](SD_GEN1_IMPLEMENTATION_PLAN_20260823.md)へ固定しました。
次段階の`SD-GEN-1`では、uf2loaderの固定traceに限定しないSDモデルの一般化
