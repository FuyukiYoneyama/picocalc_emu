...
DMA／audio低レベル回帰はbackend `6a675b1`でquantum-invariance 5/5、HIGH_PRIORITY／timer競合は`00b05f5`で5/5を合格させました。CLI／firmware再回帰が終わるまでbank復帰は保留します。隔離candidateで得た過去のexactness／性能値は
