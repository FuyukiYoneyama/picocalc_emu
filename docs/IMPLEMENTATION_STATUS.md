...
## 次の正式計画: I2C-EXT（E0〜E3完了、E4以降未完了）
...
picocalc-rtc-v1／picocalc-rtc-env-v1 profileのfixture検証・I2C1 attachを追加した。次はE4の
詳細sidecar/target接続、E5実機相関、E6 capability判断である。E0の証拠は
