...
10-run A/Bで中央値1.9094%退行かつ95% CIが0を含むため、いずれもpromotionしていません。OPT4-Cの詳細は
[`OPT4_C_DECODED_OP_8BYTE.md`](OPT4_C_DECODED_OP_8BYTE.md)に記録しています。正式promoted targetは変更していません。
