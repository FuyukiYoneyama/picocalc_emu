...
CPU単体値と実アプリ／PicoCalc全体の数値の定義・出典は、[`RP2040_CPU_MEASUREMENT_LEDGER_20260903.md`](../../RP2040_CPU_MEASUREMENT_LEDGER_20260903.md)に固定する。旧資料の111.7 MHz（117 MHzではない）と、それから派生した44.680%はraw logがなく出典未確定の参考記載であり、現行baselineやP1-A後の値として使用しない。
