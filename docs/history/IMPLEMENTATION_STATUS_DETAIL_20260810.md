...
NEXT3-7では実機後source gap分析を固定した。observer差は不一致の十分条件ではなく、残る差は優先順に
...
契約は[`NEXT4_HEADLESS_MACHINE_API.md`](../HEADLESS_MACHINE_API.md)へ固定した。protocol parser／dispatcher／
